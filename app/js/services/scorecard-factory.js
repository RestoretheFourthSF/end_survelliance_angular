var scorecardServices = angular.module('scorecardServices', []);

scorecardServices.factory('politiciansFactory', ['$http',function($http){
  function Politician() {
    this.score = 0;
    this.score_criteria = [];
  ...
  var api = {};
  api.get = function(){
    return $http.get('https://spreadsheets.google.com/feeds/list/1rTzEY0sEEHvHjZebIogoKO1qfTez2T6xNj0AScO6t24/default/public/values?alt=json').then(function(response){
      var politicians = [];

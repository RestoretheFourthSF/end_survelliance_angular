function PoliticicanCtrl($scope) {

  $scope.SPREADSHEET_URL = 'https://spreadsheets.google.com/feeds/list/1rTzEY0sEEHvHjZebIogoKO1qfTez2T6xNj0AScO6t24/default/public/values?alt=json';
  $scope.STATES = {
      'AL': 'Alabama',
      'AK': 'Alaska',
      'AZ': 'Arizona',
  ...
  $scope.Politician = Composer.Model.extend({
